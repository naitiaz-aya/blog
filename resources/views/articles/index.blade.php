...
<body>
    <div id="app">
        ...
        <div class="container">
          <div class="col-md-4">
          <a href="{{route('Categories')}}"><button class="btn btn-success px-5 py-2 primary-btn mt-2">
            All Categories
          </button></a>
          </div>
      <div class="row">
          ...
          <div class="media g-mb-30 media-comment">
            ...
            <div class="media-body u-shadow-v18 g-bg-secondary g-pa-30">
              ...
              @auth
                ...
                <a href="{{ route( 'editArticle', ['id' => $article->id])}}"><button class="btn btn-primary m-1"><i class="fas fa-edit"></i></button></a>

                @endif
            @endauth
            </div>
                <h5 class="h5 g-color-gray-dark-v1 mb-0">{{ $article->user->fname }} </h5>
                <!-- <h5 class="h5 g-color-gray-dark-v1 mb-0">{{ $article->subscri}} </h5> -->
                <span class="g-color-gray-dark-v4 g-font-size-12">{{ $article->created_at }}</span>
              </div>
              <a href="{{ route('showArticle', ['id' => $article->id])}}" class="h3">{{$article->title}} </a>
              <p class="mt-2"> Click to read this article</p>
