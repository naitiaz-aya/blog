            ...
            <form action="{{route('storeSubscription')}}" method="post" >
              ...
              <div class="row">
                ...
                <div class="form-group m-2">
                  ...
                  <input type="text" class="form-control item" placeholder="Type Here" name="type" id="title">
                </div>
                </div>
              </div>
              <div class="row">
                ...
                <div class="form-group m-2">
                  ...
                  <input type="text" class="form-control item" placeholder="Price Here" name="price" id="title">
                </div>
                </div>
              </div>
