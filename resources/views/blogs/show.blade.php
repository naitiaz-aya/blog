					...
					<div class="col-md-12 bootstrap snippets">
						<div class="panel">
							<div class="panel-body">
								<form action="{{route('storeBlogCom')}}" method="post">
									@csrf
						...
						<div class="panel-body">
							...
							<div class="media-block">
								...
								<div class="media-body">
									<div class=" mar-btm">
										<h5 class="btn-link text-semibold media-heading box-inline">{{$blogcomment->user->lname}} {{$blogcomment->user->fname}}</h5>
										<div class="col d-flex justify-content-between">


											<p class="text-muted text-sm">{{$blogcomment->created_at}}</p>
											@auth
											@if(Auth::user()->id ==$blogcomment->user_id )
											<form action="{{ route( 'deleteBlogCom', ['id' => $blogcomment->id])}}" method="post">
												@csrf
												@method('DELETE')
