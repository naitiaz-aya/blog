      ...
      <div class="row d-flex justify-content-center">
        ...
        <div class="col-sm-12">
          <div class="card mx-auto">
            <p class="h2">{{$subscriptions->type}}</p>
            
            <p class="h5 mb-4">{{ Auth::user()->fname }} {{ Auth::user()->lname }}</p>
            <form action="{{route('Subscribe', ['id' => Auth::user()->id ])}}" method="post">
            {{ csrf_field() }}
              <div class="form-group">
                <input type="hidden" value="{{$subscriptions->id}}" name="type_sub">
              </div>
              <div class="form-group mb-0">
              <p class="text-warning mb-0">Card Number</p> <input type="text" name="cardnumber" placeholder="1234 5678 9012 3457" size="16" id="cno" minlength="10" maxlength="19"> <img class="p-2" src="https://img.icons8.com/color/48/000000/visa.png" width="69px" height="66px" />
            </div>
              <div class="form-group mb-0"> <input type="date" name="end_date" id="cno" >
            </div>
